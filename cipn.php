 ...
 * @author orr
 * @link  ข้อกำหนดไฟล์ CIPN https://drive.google.com/file/d/0B-ZGLhvwK9V7YUttVk4zV2FOVjg/view?usp=sharing
 */
class cipn_xlm {
    ...
    private function CIPNClaim() {
        ...
        /**
         * @todo ค่าห้องค่าอาหารส่วนที่เกินมาจากไหน?
         */
    ...
    private function create_xml($str_hash) {
        ...
        rename($this->file_name . '.xml', 'OUT/'.$this->file_name . '.txt');
    }
